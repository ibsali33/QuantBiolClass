...
# a plot similar to hour original histogram.
ggplot(dummydata, aes(MeanCounts)) +
...
# using the tidyverse package you can quickly filter on specific genes. This
# will make it easier for us to view trends among genes.
...
# recreate our previous line plot for our filtered data set. Notice if we don't
...
Add additiona layers to emphasize features of the plot. Let's create a line plot
...
# displays a confidence interval. You can set the method used to generate
...
maintaing readability. If you want to quickly separate plots based on specific
...
sample ranges, spread and variability. There are number of ways to do this
...
categorical varaibles simultaneously. For this example. Let's use violin plots
...
# the x axis is a bit crowded. We can rotate the axis text by modifying
# the theme(). Using theme() modifications  you can customize nearly every
...
# Lets add a dotplot on top of our violin to see how each individual point falls
