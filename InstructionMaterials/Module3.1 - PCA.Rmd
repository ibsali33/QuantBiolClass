...
In this module, we will use the `tidyverse` for data formatting, the `ggplot2` package for plotting, and the `factoextra` package for principal component analysis exploration and visualization.
