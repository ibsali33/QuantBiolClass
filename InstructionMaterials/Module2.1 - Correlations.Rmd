...
For this example, we are going to use the GeneExpression data we simulated in Module 1.2 Supplement, and vizualy explored in module 1.3. 
...
Let's start by focusing on the association between gene expression and trasncription levels.
