...
deviation is indicated with the greek letter $\sigma$. What is the significance of $\lambda$?
...
Of those 15 new customers approximately two will want to make a purchase. Estimate many total customers will try to make a purchse in that 10 minute span. 
...
qnorm(0.7) 
qnorm(1.7)  # why doesn't this work? 
...
# How does this compare to the previous values collected? i.e. resampling for bootstrap
...
# This sample does not work beacuse...
#
#
#
