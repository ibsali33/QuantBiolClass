...
```{r slope_after_permutaiton, echo = TRUE}

# create a permutation index sample, and a new object with the values rearragned
...
Using a smiliar approach to our bootstrapping test, repeat the permutation test
